...
![总览](./docs/overview.jpg)

**图谱可视化（161节点，190边）**

![图谱可视化1](./docs/graph-visual-1.jpg)

![图谱可视化2](./docs/graph-visual-2.jpg)

**Simulation 准备阶段（161个Agent人设生成）**

![agent实例1](./docs/agent-1.jpg)

![agent实例2](./docs/agent-2.jpg)

**预测报告总览**

![报告总览](./docs/report.jpg)
