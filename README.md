...
![总览](./docs/screenshot-1-graph-build.jpg)

**图谱可视化（161节点，190边）**
![图谱可视化](./docs/screenshot-2-graph-visual.jpg)

![图谱可视化](./docs/screenshot-3-sim-prepare.jpg)

**Simulation 准备阶段（161个Agent人设生成）**
![agent实例](./docs/screenshot-4-sim-running.jpg)
![agent实例](./docs/screenshot-5-report-overview.jpg)

**预测报告总览**

![报告总览](./docs/screenshot-6-report-detail.jpg)
